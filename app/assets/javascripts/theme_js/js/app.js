...
(function(window, document, $, undefined) {
    ...
    function initSweetAlert() {
        ...
        $('.swal-demo5').on('click', function(e) {
            e.preventDefault();
            var pt_id = $('#d_parent').val();
            swal({
              title: "Are you sure?",
              text: "This Parent and all associated students will be deleted & archived",
              type: "warning",
              showCancelButton: true,
              confirmButtonColor: "#DD6B55",
              confirmButtonText: "Yes, delete it!",
              ...
              closeOnCancel: false
                ...
                if (isConfirm) {
                  ...
                  swal("Cancelled", "Your parent is safe :)", "error");
                }
            });
        });
        // Classroom delete popup
        $('.swal-demo6').on('click', function(e) {
            e.preventDefault();
            var lt_id = $('#d_level').val();
            swal({
              title: "Are you sure?",
              text: "This classrooms will be deleted",
              type: "warning",
              showCancelButton: true,
              confirmButtonColor: "#DD6B55",
              confirmButtonText: "Yes, delete it!",
              ...
              closeOnCancel: false
                ...
                if (isConfirm) {
                  ...
                  swal("Cancelled", "Your classroom is safe :)", "error");
                }
            });
        });
        // Student delete popup
        $('.swal-demo7').on('click', function(e) {
          e.preventDefault();
          var st_id = $('#d_student').val();
          swal({
            title: "Are you sure?",
            text: "This student and all associated data will be deleted and Archived",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Yes, delete it!",
            ...
            closeOnCancel: false
              ...
              if (isConfirm) {
                ...
                swal("Cancelled", "Your student is safe :)", "error");
              }
            });
        });
        // Type Delete popup
